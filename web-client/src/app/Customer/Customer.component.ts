...
export class CustomerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.coyote.playground.blockchain.demo.Customer',
  ...
  assignParticipant(): Promise<any> {
    this.user = {
      "participant": "org.coyote.playground.blockchain.demo.Customer#" + this.currentId,
      "userID": this.userid.value,
      "options": {}
    }
    return this.serviceCustomer.assignParticipant(this.user)
      .toPromise()
      .then(() => {
        this.errorMessage = null;
      })
