...
export class BrokerComponent implements OnInit {
  ...
  constructor(private serviceBroker: BrokerService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.coyote.playground.blockchain.demo.Broker',
  ...
  assignParticipant(): Promise<any> {
    this.user = {
      "participant": "org.coyote.playground.blockchain.demo.Broker#" + this.currentId,
      "userID": this.userid.value,
      "options": {}
    }
    return this.serviceBroker.assignParticipant(this.user)
      .toPromise()
      .then(() => {
        this.errorMessage = null;
      })
  ...
  updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceBroker.updateParticipant(form.get('email').value, this.participant)
      .toPromise()
      .then(() => {
        this.errorMessage = null;
        this.loadAll();
