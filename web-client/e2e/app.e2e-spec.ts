...
describe('Starting tests for client', function() {
  ...
  it('network-name should be coyote-playground-blockchain-demo@0.0.5',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('coyote-playground-blockchain-demo@0.0.5.bna');
    });
  });
  ...
  it('navbar-brand should be client',() => {
    ...
    it('Contract table should have 14 columns',() => {
      page.navigateTo('/Contract');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Carrier table should have 6 columns',() => {
      page.navigateTo('/Carrier');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(6); // Addition of 1 for 'Action' column
      });
    ...
    it('Broker table should have 6 columns',() => {
      page.navigateTo('/Broker');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(6); // Addition of 1 for 'Action' column
      });
    ...
    it('Facility component should be loadable',() => {
      ...
      .then((txt) => {
        expect(txt).toBe('Facility');
      });
    });

    it('Facility table should have 3 columns',() => {
      page.navigateTo('/Facility');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('ShipmentAccepted component should be loadable',() => {
      page.navigateTo('/ShipmentAccepted');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('ShipmentAccepted');
      });
    });
